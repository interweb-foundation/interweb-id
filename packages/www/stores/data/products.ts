...
export const ProductListData: Product[] = [
    ...
    // },
    {
        ...
        images:
        {
            light: '/logos/starship/logo.png',
            dark: '/logos/starship/logo.png',
        }
        ,
        text: 'A k8s based unified development environment for Cosmos Ecosystem (and beyond)',
        href: 'https://github.com/cosmology-tech/starship',
        tags: [
            'kubernetes',
            'CI/CD'
        ]
