...
export declare const SimpleInstallWalletButton: ({ icon, text }: DownloadWalletButtonType) => JSX.Element;
...
export declare const SimpleDisplayWalletList: ({ initialFocus, walletsData, handleClick }: DisplayWalletListType) => JSX.Element;
