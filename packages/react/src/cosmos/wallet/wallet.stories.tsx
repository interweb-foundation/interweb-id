...
import {
  ...
  SimpleQRCodeV1
} from './SimpleConnectModalContentV1';
import { SimpleModalHead } from './SimpleConnectModalHead';
import { SimpleModalHeadV1 } from './SimpleConnectModalHeadV1';
import { SimpleConnectModalV1 } from './SimpleConnectModalV1';
              ...
              <SimpleDisplayModalContent
                ...
                contentDesc={
                  walletStatus === STATUS.Connecting
                    ? `Open ${selectedWallet.prettyName} to connect your wallet.`
...
storiesOf('Cosmology/wallet', module).add('SimpleConnectModalV1', () => {
  const getRandomAddress = getShuffledArr(chainList)[0].address;
  const walletStatus = select('wallet status', STATUS, STATUS.Connecting);
